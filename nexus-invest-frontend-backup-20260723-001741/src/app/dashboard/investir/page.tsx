    ...
    <div className="flex flex-col gap-6">
      <div>
        ...
        <p className="text-sm text-slate-500 dark:text-slate-400">
          {t('Choisissez le pack qui correspond à vos objectifs')}
        </p>
      </div>
      ...
      <GlassCard variant="highlight" padding="sm" className="flex items-start gap-3">
        ...
        <p className="text-sm text-slate-700 dark:text-slate-300">
          <strong>{t('Conseil')} :</strong> {t('Plus le pack est long, plus le rendement est élevé ! Choisissez judicieusement en fonction de vos objectifs.')}
        </p>
      </GlassCard>
