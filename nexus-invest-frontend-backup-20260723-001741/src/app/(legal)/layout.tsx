      ...
      <header className="sticky top-0 z-40 w-full border-b border-white/10 bg-white/80 dark:bg-slate-900/80 backdrop-blur-xl">
        <div className="mx-auto max-w-7xl flex h-16 items-center justify-between px-4 sm:px-6 lg:px-8">
          <Link href="/" className="flex items-center gap-2">
            ...
            <span className="text-lg font-bold text-slate-900 dark:text-white">NexusCoin</span>
          </Link>
        ...
        <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
          <div className="flex flex-col items-center gap-4 sm:flex-row sm:justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-sm font-bold text-slate-900 dark:text-white">NexusCoin</span>
            </div>
            <p className="text-xs text-slate-400 dark:text-slate-500">&copy; {new Date().getFullYear()} NexusCoin. Tous droits réservés.</p>
          </div>
        </div>
      </footer>
    </div>
