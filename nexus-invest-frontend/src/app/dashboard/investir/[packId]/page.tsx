...
const paymentMethods: { id: PaymentMethod; labelKey: string; descKey: string; icon: typeof CreditCard }[] = [
  { id: 'carte', labelKey: 'payment.card', descKey: 'invest.card_visa', icon: CreditCard },
  { id: 'mobile_money', labelKey: 'payment.mobile_money', descKey: 'invest.mobile_money', icon: Smartphone },
  { id: 'virement', labelKey: 'payment.bank_transfer', descKey: 'invest.bank_transfer', icon: Building2 },
];
...
export default function CheckoutPage() {
  ...
  const { packs, loading: packsLoading, createInvestment } = useInvestments();
  ...
  return (
    <div className="flex flex-col gap-6 max-w-2xl mx-auto">
      ...
      <h1 className="text-2xl font-bold text-slate-900 dark:text-white">{t('invest.finalize')}</h1>
